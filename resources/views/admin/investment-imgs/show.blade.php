...
@section('main')
    <div class="card-header d-flex align-items-center justify-content-between">
        <h2 class="card-title">All {{ $invest->project_name }} images</h2>

        <div class="card-tools ">
            @include('admin.inc.errors')
            <form action="{{ url('dashboard/invest/images') }}" method="post" enctype="multipart/form-data">
                @csrf
        ...
        @foreach ($imgs as $img)
            ...
            <div class="col-md-4">
                <div class="card" style="width: 18rem;">
                    <img style="height: 300px" src="{{ asset("uploads/investments/$img->name") }}" class="card-img-top">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <form  id="delete_form" action="{{url("dashboard/invest/images/$img->id")}}" method="POST">
                            @csrf
                            @method('DELETE')
